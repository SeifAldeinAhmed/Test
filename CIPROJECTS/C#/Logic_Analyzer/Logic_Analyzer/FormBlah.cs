    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                textBox4.Text = p1;
                textBox5.Text = p2;
                e0 = Convert.ToInt32(p0);
                e1 = Convert.ToInt32(p1);
                e2 = Convert.ToInt32(p2);
                counter++;
                time += ((e2 * 8) / 1000);
                chart1.Series["signal"].Points.AddXY(time, e0);
                //if (time <= (chart.AxisX.Maximum-50))
                    //{
                        waving += 1;
                        chart.AxisX.Minimum = waving-400;
